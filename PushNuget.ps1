...
$apiKey = ""
# $packagePath = "C:\git\wtg\Blazor.Diagrams\src\Blazor.Diagrams.Core\bin\Debug\WTG.Z.Blazor.Diagrams.Core.1.0.6.nupkg"
$packagePath = "C:\git\wtg\Blazor.Diagrams\src\Blazor.Diagrams\bin\Debug\WTG.Z.Blazor.Diagrams.1.0.6.nupkg"
